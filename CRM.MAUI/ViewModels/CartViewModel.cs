...
namespace CRM.MAUI.ViewModels
{
    public class CartViewModel : INotifyPropertyChanged
    {
        ...
        //===Remove Cart====//
        public void RemoveLastCart()
        {
            if (ShoppingCartService.Current.ListOfCarts == null && ShoppingCartService.Current?.ListOfCarts?.Count == 1)
            {
                return;
            }
            ShoppingCartService.Current?.DeleteCart();
            NotifyPropertyChanged(nameof(Carts));
