    ...
    public class ShoppingCartService
    {
        ...
        public ShoppingCart Cart
        {
            get
            {
                ...
                {
                    var newCart = new ShoppingCart { Id = NextCartId, Contents = new ObservableCollection<ProductDTO>() };
        ...
        public void AddToCart(ProductDTO newProduct) //adds into the current cart 
        {
        ...
        public void RemoveFromCart(ProductDTO product)
{
        ...
        public void AddToCartInCart(ShoppingCart cart, ProductDTO product) //adds the product in a cart on the lis of carts
        {
        ...
        {
            var cartToDelete = Current.listofCarts.Last();
            if (cartToDelete != null && Current.ListOfCarts.Count > 1)
            {
                Current.listofCarts.Remove(cartToDelete);
            }
        }
